...
// and service contract for searching the marketplace are intentionally
// identical: search is the marketplace's product surface and we don't want
// a translation layer between what callers send and what the engine receives.
...
// validateSearchRequest enforces required fields on the request.
